...
## Update (18/10/25) ## 
After implementing a new Input System, fixing assembly issues, and recovering lost files, the current build is a little broken. While blocks can be clicked on, they cannot be dragged nor placed. We're currently working on restoring functionality and also just improving general code quality. 
